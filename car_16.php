    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <p class="text-justify">
                Là đơn vị cung cấp dịch vụ vận chuyển hành khách <strong>Uy tín – Chuyên nghiệp – Giá rẻ</strong> tại Cần Thơ và các tỉnh miền Nam, TamHang Tourist luôn đồng hành cùng Quý khách trên mọi hành trình với phương châm <strong>“Khách hàng là trung tâm”</strong>.
            </p>

            <p class="text-justify">
                Xe 16 chỗ là giải pháp lý tưởng cho <strong>nhóm đông người</strong>, phù hợp với nhu cầu di chuyển cho gia đình lớn, công ty, trường học, đưa đón khách sự kiện, tham quan du lịch, hành hương, v.v.
            </p>
            ...
            <p class="mt-4 fs-5 text-dark"><strong>Đặt ngay xe 16 chỗ để có chuyến đi trọn vẹn, thoải mái và an toàn cùng TamHang Tourist!</strong></p>
